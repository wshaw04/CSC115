...
public class Lab3Tester {
	...
	public static void testRectangleArea() {
		...
		Shape r93 = new Rectangle(9, 3, p00);
		...
		result = r93.area();
		System.out.println(result);
		displayResults(Math.abs(result-expected) < THRESHOLD, "testRectangleArea - 9 by 3");
	...
	public static void testRectanglePerimeter() {
		...
		expected = (9 + 3) * 2;
		result = r93.perimeter();
		displayResults(Math.abs(result-expected) < THRESHOLD, "testRectanglePerimeter - 9 by 3");
